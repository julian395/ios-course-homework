...
class SettingsTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath)
    {
        ...
        let callAction = UIAlertAction(title: "Date", style: .Default, handler: CallActionHandler)
        let callAction2 = UIAlertAction(title: "Date and Time", style: .Default, handler: CallActionHandler2)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("CellSet", forIndexPath: indexPath) as! UITableViewCell
